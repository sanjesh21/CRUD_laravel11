                    ...
                    <div class="card border-0 shadow-lg">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{old('price')}}"type="number" class="@error('price') is-invalid @enderror form-control form-control-lg" placeholder="Price" name="price">
                                @error('price')
                                <p class="invalid-feedback">{{$message}}</p>                                    
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <textarea placeholder="Description" cols="30" rows="5" class="form-control form-control-lg" name="description" value="{{ old('description') }}"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="">Image</label>
                                <input type="file" class="form-control form-control-lg" placeholder="Choose image file.." name="image">
                            </div>
                            <div class="d-grid">
