              ...
              <dic class="card-body">
                <table class="table">
                 ...
                 <tr>
                  ...
                  <td>
                    <a href="{{ route('products.edit',$product ->id)}}" class="btn btn-dark m-2 d-flex justify-content-center">Edit</a>
                    <a href="#" class="btn btn-danger m-2 d-flex justify-content-center" onclick="deleteProduct({{ $product->id}})">Delete</a>
